...
def Network_18_nodes_data():
    ...
    length_km =  1
    R = [0.0, 0.0174, 0.0001, 0.0052, 0.0003, 0.0010, 0.0017, 0.0022, 0.0001, 0.0016, 0.0007, 0.0299, 0.0010, 0.0025, 0.0011, 0.0034, 0.0013]
    X = [0.1, 0.0085, 0.0001, 0.0028, 0.0002, 0.0010, 0.0008, 0.0011, 0.0000, 0.0008, 0.0003, 0.0081, 0.0010, 0.0007, 0.0003, 0.0009, 0.0004]
    R = [k*12.1 for k in R]
    X = [k*12.1 for k in X]
    C = 0
    Imax = 0
