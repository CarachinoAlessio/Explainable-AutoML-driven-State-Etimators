...
data_y = np.load('../nets/net_95_data/data_y.npy')
#measured_x = np.load('../nets/net_95_data/measured_data_x.npy')
#measured_y = np.load('../nets/net_95_data/measured_data_y.npy')
'''
#stable_x = np.load('../nets/net_95_data/measured_data_x_stable.npy')
#stable_y = np.load('../nets/net_95_data/data_y_stable.npy')

alt_x = np.load('../net95/simulations_net95/net_95_v3/measured_data_x_alt.npy')
alt_y = np.load('../net95/simulations_net95/net_95_v3/data_y_alt.npy')
...
if train_time or True:
    ...
    for t in range(epochs):
        ...
        s1_c1_data = get_data_by_scenario_and_case(1, 1, net_name='net95v3')
        x = s1_c1_data[0]
        x_hat = s1_c1_data[1]
        y = s1_c1_data[2]
        y_hat = s1_c1_data[3]
        ...
        s1_c1_data = get_data_by_scenario_and_case(2, 1, net_name='net95v3')
        x = s1_c1_data[0]
        x_hat = s1_c1_data[1]
        y = s1_c1_data[2]
        y_hat = s1_c1_data[3]
        ...
        s1_c1_data = get_data_by_scenario_and_case(3, 1, net_name='net95v3')
        x = s1_c1_data[0]
        x_hat = s1_c1_data[1]
        y = s1_c1_data[2]
        y_hat = s1_c1_data[3]
        ...
        s1_c1_data = get_data_by_scenario_and_case(4, 1, net_name='net95v3')
        x = s1_c1_data[0]
        x_hat = s1_c1_data[1]
        y = s1_c1_data[2]
        y_hat = s1_c1_data[3]
        ...
        s1_c1_data = get_data_by_scenario_and_case(5, 1, net_name='net95v3')
        x = s1_c1_data[0]
        x_hat = s1_c1_data[1]
        y = s1_c1_data[2]
        y_hat = s1_c1_data[3]
        ...
        if t > epochs - 30:
            if (new_root_mse := test(test_dataloader, model, loss_fn, plot_predictions=False)) < root_mse:
                ...
                torch.save(model.state_dict(), "model_net95.pth")
                #torch.save(optimizer.state_dict(), "optimizer_n.pth")
                print("Saved.")
        '''
