...
from a1.retrain import get_incr_data_and_shap_values
...
incremental_data, shap_list = get_incr_data_and_shap_values(val_dataloader, model, loss_fn, voltage_threshold=0.27)
print("--------- Done ---------")